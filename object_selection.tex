...
\begin{figure}[htb]
    \begin{center}
        \includegraphics[width=0.45\linewidth]{./figures/object_selection/tau_trig_eff_ztt_1p.eps}
        \includegraphics[width=0.45\linewidth]{./figures/object_selection/tau_trig_eff_tt_1p.eps}
