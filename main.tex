...
%hyperref
\newcommand{\hreftitle}{Optimizing the measurement of the signal strength for Higgs-boson production in the H->TauTau decay using multivariate techniques at sqrt(s) = 13 TeV with the ATLAS detector}
