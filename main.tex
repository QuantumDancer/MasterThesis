...
%hyperref
\newcommand{\hreftitle}{Application of multivariate techniques in the search for H->TauTau using the dileptonic decay channel using multivariate techniques at sqrt(s) = 13 TeV with the ATLAS detector}
...
\newcommand{\lagl}{\ensuremath{\mathcal{L}}}
...
\newcommand{\etmisshptox}{\ensuremath{E_\text{T,x}^\text{miss,HPTO}}}
\newcommand{\etmisshptoy}{\ensuremath{E_\text{T,y}^\text{miss,HPTO}}}
\newcommand{\etmisshptophi}{\ensuremath{E_{\text{T},\phi}^\text{miss,HPTO}}}
